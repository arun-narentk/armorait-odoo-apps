...
class ResConfigSettings(models.TransientModel):
    ...
    ai_employee_enabled = fields.Boolean(
        ...
        config_parameter='ai_employee.enabled',
    )
    ai_employee_provider = fields.Selection(
        ...
        string='AI Provider',
        config_parameter='ai_employee.provider',
        default='openai',
    )
    ai_employee_api_key = fields.Char(
        string='API Key',
        config_parameter='ai_employee.api_key',
    )
    ai_employee_api_url = fields.Char(
        string='API URL',
        config_parameter='ai_employee.api_url',
        default='https://api.openai.com/v1/chat/completions',
    )
    ai_employee_model = fields.Char(
        string='Model Name',
        config_parameter='ai_employee.model',
        default='gpt-4o-mini',
    )
    ai_employee_temperature = fields.Float(
        string='Temperature',
        config_parameter='ai_employee.temperature',
        default=0.2,
    )
