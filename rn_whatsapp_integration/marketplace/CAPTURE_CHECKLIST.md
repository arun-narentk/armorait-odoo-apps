# Capture Checklist: WhatsApp Integration

Technical name: `rn_whatsapp_integration`
...
- [ ] `search.png` (search)
- [ ] `mobile.png` (mobile)
- [ ] `main_screenshot.png` (main)

## GIFs (20-30 seconds each)
- [ ] `hero.gif` (hero)
...
## Publish
- [ ] Run `python build_marketplace.py rn_whatsapp_integration`
- [ ] Review static/description/index.html
- [ ] Package ZIP and upload to Odoo Apps Store
- [ ] Support contact: info@armorait.com
